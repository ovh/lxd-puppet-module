...
class lxd::config{
    ...
    $lxd_core_https_address = $lxd::lxd_core_https_address
    $lxd_core_https_address_ensure = $lxd::lxd_core_https_address_ensure
    $lxd_core_trust_password = $lxd::lxd_core_trust_password
